...
const products = [
  ...
  },
  {
    ...
    tagline: "The memory layer of the ecosystem.",
    description:
      "A living archive of altered-state knowledge — field observations, emergent patterns, and human experience mapped across substances, systems, and outcomes.",
    logo: "/logos/asa.svg",
    logoWidth: 120,
    logoHeight: 120,
    logoClass: "h-16",
    panel:
      "border-[#9b5de5]/28 bg-[#1a0533]/[0.35] hover:border-[#9b5de5]/60 hover:shadow-[0_0_32px_rgba(155,93,229,0.20)]",
    glow: "bg-[#9b5de5]/18",
