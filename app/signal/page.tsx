  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden pt-36 pb-20 lg:pt-44 lg:pb-24">
        {/* Signal = electric blue — never teal, never orange */}
        ...
        <Container>
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-1 gap-3">
              {steps.map((step) => (
                <Card key={step.label} accent="blue">
                  <div className="flex gap-4 items-start">
                    <span className="text-[11px] font-semibold text-vl-blue/60 font-mono mt-0.5 shrink-0">{step.label}</span>
                    <div>
                      <h3 className="text-sm font-semibold text-vl-blue mb-1">{step.title}</h3>
